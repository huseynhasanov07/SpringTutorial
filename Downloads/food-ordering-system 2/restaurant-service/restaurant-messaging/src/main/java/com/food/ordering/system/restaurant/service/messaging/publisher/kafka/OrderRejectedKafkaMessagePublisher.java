...
public class OrderRejectedKafkaMessagePublisher implements OrderRejectedMessagePublisher {
    ...
    public OrderRejectedKafkaMessagePublisher(KafkaProducer<String, RestaurantApprovalResponseAvroModel> kafkaProducer, RestaurantMessagingDataMapper restaurantMessagingDataMapper, RestaurantServiceConfigData restaurantServiceConfigData, KafkaMessageHelper kafkaMessageHelper) {
