...
public class OrderApprovedKafkaMessagePublisher implements OrderApprovedMessagePublisher {
    ...
    public OrderApprovedKafkaMessagePublisher(KafkaProducer<String, RestaurantApprovalResponseAvroModel> kafkaProducer, RestaurantMessagingDataMapper restaurantMessagingDataMapper, RestaurantServiceConfigData restaurantServiceConfigData, KafkaMessageHelper kafkaMessageHelper) {
    ...
    public void publish(OrderApprovedEvent orderApprovedEvent) {
        ...
        try {
            RestaurantApprovalResponseAvroModel restaurantApprovalResponseAvroModel =
                    restaurantMessagingDataMapper.orderApprovalEventToRestaurantApprovalResponseAvroModel(orderApprovedEvent);
            kafkaProducer.send
            ...
            log.info("RestaurantApprovalResponseAvroModel send to kafka at:{}", System.nanoTime());
        } catch (Exception e) {
