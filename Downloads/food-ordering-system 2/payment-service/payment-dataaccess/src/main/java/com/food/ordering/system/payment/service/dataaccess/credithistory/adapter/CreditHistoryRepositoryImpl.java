...
public class CreditHistoryRepositoryImpl implements CreditHistoryRepository {
    ...
    @Override
    public Optional<List<CreditHistory>> findCustomerById(CustomerId customerId) {
        ...
        return creditHistory.map(
                creditHistoryList -> creditHistoryList.stream().map(
                        creditHistoryDataAccessMapper::creditHistoryEntityToCreditHistory
